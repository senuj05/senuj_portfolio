    ...
    <footer id="contact" className="mt-0">
      ...
      <div className={`relative overflow-visible rounded-t-3xl px-6 md:px-12 lg:px-24 py-16 md:py-20 ${variant === 'dark' ? 'bg-[#180E0E]' : 'bg-[#53232A]'}`}>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex flex-col items-center justify-center gap-6 mb-6">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="p-3 rounded-full bg-white text-gray-900 hover:bg-white/90 transition-colors"
                aria-label="LinkedIn"
              >
          ...
          <p className="text-white/90 text-sm">This website is best viewed on Desktop</p>
